    ...
    Message: {
      Body: {
        Html: {
          Data:
            `<p>Greetings ${name}`
            + `, <br /><br /> This is a dummy email that is being sent for testing purposes.`
            + '</strong>.<br /><br /><strong>Pleae ignore the email if you receive it by mistake.'
            + "<p><br><strong>Thanks for your cooperation!</p>"
