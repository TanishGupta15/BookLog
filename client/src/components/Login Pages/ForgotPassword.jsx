...
import {
  Box, Stack, Heading, Input, Button, Image, FormControl, Text
  ...
  return (
    <Box>
      ...
      <Box align={'center'} className="main" pt={10}>
        <Stack w={'f ull'} bg={'gray.200'} rounded={'xl'}
          p={{ base: 4, sm: 6, md: 8 }} spacing={{ base: 8 }}
          maxW={{ base: 'sm', md: 'md' }}>
          <Heading lineHeight={1.1} fontSize={{ base: '2xl', md: '3xl' }} color={'gray.800'}>
